    ...
    <div className="admin-page">
      ...
      <form onSubmit={handleSave} style={{ display: 'grid', gridTemplateColumns: '1fr 350px', gap: 24, alignItems: 'start' }}>
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
          ...
          <div className="admin-card" style={{ padding: 24, borderRadius: 12, background: 'var(--admin-card-bg)' }}>
            ...
            <div style={{ display: 'grid', gridTemplateColumns: '1fr 1fr', gap: 16 }}>
              ...
              <div className="admin-form-group">
                ...
                <input value={form.author?.role} onChange={e => setForm({ ...form, author: { ...form.author, role: e.target.value }})} />
              </div>
              <div className="admin-form-group">
                <label>Company / Organization</label>
                <input value={form.author?.company} onChange={e => setForm({ ...form, author: { ...form.author, company: e.target.value }})} />
              </div>
              <div className="admin-form-group">
                <label>LinkedIn URL</label>
                <input value={form.author?.linkedinUrl} onChange={e => setForm({ ...form, author: { ...form.author, linkedinUrl: e.target.value }})} />
              </div>
            </div>
          ...
          <div className="admin-card" style={{ padding: 24, borderRadius: 12, background: 'var(--admin-card-bg)' }}>
            ...
            <div className="admin-form-group">
              ...
              <textarea rows={2} value={form.seo?.metaDescription} onChange={e => setForm({ ...form, seo: { ...form.seo, metaDescription: e.target.value }})} />
            </div>
            <div className="admin-form-group">
        ...
        <div style={{ display: 'flex', flexDirection: 'column', gap: 24 }}>
          ...
          <div className="admin-card" style={{ padding: 24, borderRadius: 12, background: '#1e1e2d' }}>
