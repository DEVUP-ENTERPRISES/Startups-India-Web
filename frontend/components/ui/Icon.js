...
export function Icon({ name, size = 20, color = 'currentColor', stroke = 2, fill = 'none', className = '' }) {
  ...
  const icons = {
    ...
    fire:           <svg {...p}><path d="M8.5 14.5A2.5 2.5 0 0 0 11 12c0-1.38-.5-2-1-3-1.072-2.144-.22-4.098 1-6 2.052 3.284 1.76 6.84 3 10a5 5 0 0 1 5 5A7 7 0 0 1 5 19.5a7 7 0 0 1 3.5-5Z"/></svg>,
