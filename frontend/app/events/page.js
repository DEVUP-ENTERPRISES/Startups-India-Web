...
export default function EventsPage() {
  ...
  const featuredEvent = sortedEvents.find(e => e.featured) || sortedEvents[0] || null;
  ...
  const scrollCarousel = (dir) => {
    const next = Math.max(0, Math.min(totalCarouselPages - 1, carouselPage + dir));
        ...
        <div className="edc-inner">
          ...
          <div className="edc-header">
            <div className="edc-header-left">
              ...
              <p className="edc-subtitle">Find the perfect event that matches your interests</p>
            </div>
            <div className="edc-header-right">
              <div className="edc-price-wrap">
                {/* tag / price icon */}
                <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="#e63946" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
                ...
                <svg className="edc-chevron" width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
          ...
          <div className="edc-body">
            ...
            <div className="edc-cat-panel" role="tablist" aria-label="Event categories">
              {categories.slice(0, 7).map((cat, idx) => {
                ...
                return (
                  ...
                  >
                    ...
                    <span className="edc-cat-count" aria-label={`${cat.count} events`}>
                      {cat.count}
                    </span>
                  </button>
                );
            ...
            {(() => {
              ...
              // Events matching selected category (no price filter here — just category preview)
              ...
              return (
                ...
                >
                  {/* Event image occupies right portion */}
                  <div
                    className="edc-preview-bg"
                    style={{ backgroundImage: `url(${hasEvents ? previewImg : ''})` }}
                    aria-hidden="true"
                  />
                  ...
                  <div className="edc-preview-content">
                    ...
                    {hasEvents ? (
                      ...
                      <>
                        <p className="edc-preview-empty-title">No events available yet</p>
                        <p className="edc-preview-desc">
                          Check back soon — new {activeCat.label.toLowerCase()} events are added regularly.
                        </p>
                      </>
                    )}
        ...
        <div className="aes-inner">
          ...
          <div className="aes-header">
            <div className="aes-header-left">
              <h2 className="aes-heading">
                {selectedCategory === 'all'
                  ? 'All Events'
                  : categories.find(c => c.id === selectedCategory)?.label || 'All Events'}
              </h2>
            ...
            <div className="aes-header-right">
              <div className="aes-sort-wrap">
                {/* small calendar icon */}
                <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#e63946" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
                  <rect x="3" y="4" width="18" height="18" rx="2" ry="2"/>
                  <line x1="16" y1="2" x2="16" y2="6"/>
                  <line x1="8" y1="2" x2="8" y2="6"/>
                  <line x1="3" y1="10" x2="21" y2="10"/>
                ...
                <select
                  ...
                  value={sortBy}
                  onChange={e => { setSortBy(e.target.value); setCarouselPage(0); }}
                ...
                <svg className="aes-sort-chevron" width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
                  <polyline points="6 9 12 15 18 9"/>
                </svg>
              </div>
            </div>
          ...
          {!loading && error && (
            <div className="aes-empty">
              ...
              <button className="aes-retry-btn" onClick={fetchEvents}>Try Again</button>
            </div>
          )}

          {!loading && !error && filteredEvents.length === 0 && (
            <div className="aes-empty">
              <svg width="56" height="56" viewBox="0 0 24 24" fill="none" stroke="#d1d5db" strokeWidth="1.5" aria-hidden="true">
                <rect x="3" y="4" width="18" height="18" rx="2" ry="2"/>
                <line x1="16" y1="2" x2="16" y2="6"/>
                <line x1="8" y1="2" x2="8" y2="6"/>
                <line x1="3" y1="10" x2="21" y2="10"/>
              ...
              {hasActiveFilters && (
                <button
                  ...
                  onClick={() => { setSelectedCategory('all'); setPriceFilter('all'); setSearchQuery(''); }}
                >
                  Clear Filters
                </button>
              )}
            ...
            >
              ...
              <div className="aes-featured-body">
                ...
                <div
                  ...
                  onClick={() => router.push(`/events/${featuredEvent._id || featuredEvent.id}`)}
                  role="button"
                  tabIndex={0}
                  onKeyDown={e => {
                    if (e.key === 'Enter' || e.key === ' ') {
                      e.preventDefault();
                      router.push(`/events/${featuredEvent._id || featuredEvent.id}`);
                    }
                  }}
                  aria-label={`View ${featuredEvent.title}`}
                >
                  <img
                    src={featuredEvent.coverImage || featuredEvent.image || DEFAULT_EVENT_IMAGE}
                ...
                <div className="aes-feat-info">
                  ...
                  <div className="aes-feat-meta">
                    <div className="aes-feat-meta-col">
                      <div className="aes-meta-label">
                        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#e63946" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
                          <rect x="3" y="4" width="18" height="18" rx="2" ry="2"/>
                          <line x1="16" y1="2" x2="16" y2="6"/>
                          <line x1="8" y1="2" x2="8" y2="6"/>
                          <line x1="3" y1="10" x2="21" y2="10"/>
                      ...
                      <div className="aes-meta-value">{formatFeaturedDate(featuredEvent)}</div>
                    </div>
                    <div className="aes-feat-meta-col">
                      <div className="aes-meta-label">
                        <svg width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="#e63946" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
                      ...
                      <div className="aes-meta-value">
                        {featuredEvent.mode || (featuredEvent.venue ? 'Offline' : 'Online')}
                      </div>
                    </div>
                  </div>
                  ...
                  <div className="aes-feat-footer">
                    ...
                    {(() => {
                      ...
                      return (
                        <span className={`aes-feat-price${p.isFree ? ' free' : ''}`}>
                          {p.label}
                          {p.original && <s className="aes-feat-original">{p.original}</s>}
                        </span>
                      );
                    })()}
                      ...
                      <div className="aes-card-img-wrap">
                        ...
                        {badge && (
                          <div className="aes-date-badge" aria-hidden="true">
                            <span className="aes-badge-month">{badge.month}</span>
                      ...
                      <div className="aes-card-body">
                        ...
                        <div className="aes-card-meta">
                          <div className="aes-card-row">
                            <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="#e63946" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" aria-hidden="true">
                              <rect x="3" y="4" width="18" height="18" rx="2" ry="2"/>
                              <line x1="16" y1="2" x2="16" y2="6"/>
                              <line x1="8" y1="2" x2="8" y2="6"/>
                              <line x1="3" y1="10" x2="21" y2="10"/>
                          ...
                          <div className="aes-card-row">
                            ...
                            <span>{event.venue || event.city || event.location || (event.mode === 'Online' ? 'Online' : 'Online')}</span>
                          </div>
                        </div>
                        ...
                        <div className="aes-card-footer">
                          {(() => {
                            ...
                            return (
                              <span className={`aes-card-price${p.isFree ? ' free' : ''}`}>
                                {p.label}
                              </span>
                            );
                          })()}
                    ...
                    <button
                      ...
                      onClick={() => {
                        ...
                        if (carouselRef.current) {
                          const el = carouselRef.current;
                          const cardW = el.scrollWidth / Math.max(upcomingEvents.length, 1);
                          el.scrollTo({ left: i * CARDS_PER_PAGE * cardW, behavior: 'smooth' });
                        }
                      }}
                      role="tab"
